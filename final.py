...
def take_bet(chips):
    while True:
        try:
            ...
            print('Sorry chip must be an integer 0-100 ')
        else:
...
def push(player, dealer):
    print('Dealer and Player tie! It is a draw.')
...
while True:
    ...
    print("\nPlayer's innings stand at ", player_chips.total)

    new_game = input("Would you like to play another hand? Enter y ")
